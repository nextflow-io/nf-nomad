...
class ConfigDiscovery {
     ...
     * @return The e
     */
    nextflow.k8s.client.ClientConfig discover(String contextName, String namespace, String serviceAccount) {
    ...
    protected nextflow.k8s.client.ClientConfig fromCluster(Map<String,String> env, String cfgNamespace, String serviceAccount) {
        ...
        return new nextflow.k8s.client.ClientConfig(
                server: server,
                token: token,
    ...
    protected nextflow.k8s.client.ClientConfig fromKubeConfig(Path path, String contextName, String namespace, String serviceAccount) {
        ...
        final config = nextflow.k8s.client.ClientConfig.fromUserAndCluster(user, cluster, path)
    ...
    protected KeyStore createKeyStore0(byte[] clientCert, byte[] clientKey, char[] passphrase, String alg) {
        ...
        return nextflow.k8s.client.SSLUtils.createKeyStore(cert, key, alg, passphrase, null, null)
    }
