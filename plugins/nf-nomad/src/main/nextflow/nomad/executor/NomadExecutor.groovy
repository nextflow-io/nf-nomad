...
//@ServiceName('nomad')
//@CompileStatic
//class nextflow.nomad.executor.NomadExecutor extends Executor implements ExtensionPoint {
//
...
//        def batchService = new nextflow.nomad.executor.NomadService(this)
//
//        def nomadBatchExecutor = new ApiClient(this)
//
...
//        return new nextflow.nomad.executor.NomadTaskHandler(task, this)
//    }
//
//    nextflow.nomad.executor.NomadService getBatchService() {
//        return batchService
//    }
//
//    nextflow.nomad.executor.NomadExecutor getNomadBatchExecutor() {
