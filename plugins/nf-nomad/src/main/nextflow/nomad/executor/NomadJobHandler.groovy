...
//
//    private nextflow.k8s.K8sExecutor executor
//
//    private String runsOnNode = null
//
//    K8sTaskHandler(TaskRun task, nextflow.k8s.K8sExecutor executor ) {
//        super(task)
...
//    }
//
//    protected nextflow.k8s.K8sConfig getK8sConfig() { executor.getK8sConfig() }
//
...
//                ? fusionLauncher()
//                : new nextflow.k8s.K8sWrapperBuilder(task)
//    }
//
