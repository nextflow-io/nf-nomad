...
//@Slf4j
//@CompileStatic
//class nextflow.nomad.executor.NomadTaskHandler extends TaskHandler {
//
//    nextflow.nomad.executor.NomadExecutor executor
//
...
//
//    nextflow.nomad.executor.NomadTaskHandler(TaskRun task, nextflow.nomad.executor.NomadExecutor executor) {
//        super(task)
...
//    protected nextflow.nomad.executor.NomadTaskHandler() {}
//
