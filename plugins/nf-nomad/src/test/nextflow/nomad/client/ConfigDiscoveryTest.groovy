...
//            .stripIndent()
//
//        def discovery = Spy(nextflow.k8s.client.ConfigDiscovery)
...
//
//        when:
//        def cfg1 = new nextflow.k8s.client.ConfigDiscovery().fromKubeConfig(CONFIG, 'dev-frontend', null, null)
//        then:
...
//
//        when:
//        def cfg2 = new nextflow.k8s.client.ConfigDiscovery().fromKubeConfig(CONFIG, 'dev-storage', null, null)
//        then:
...
//
//        when:
//        def cfg3 = new nextflow.k8s.client.ConfigDiscovery().fromKubeConfig(CONFIG, 'exp-scratch', null, null)
//        then:
...
//
//        when:
//        new nextflow.k8s.client.ConfigDiscovery().fromKubeConfig(CONFIG, 'foo', null, null)
//        then:
...
//        final discovery = new nextflow.k8s.client.ConfigDiscovery()
//        when:
