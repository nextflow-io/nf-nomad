...
class NomadConfigTest extends Specification {
    ...
    def 'should get nomad client object'() {
        ...
        given:
        def SERVER_ADDR = "http://nomad.api"
        def TOKEN = "abcdefghijklm"
        and:
...
//
//        def config = new nextflow.k8s.client.ClientConfig()
...
//
//        when:
//        def result = nextflow.k8s.client.ClientConfig.fromNextflowConfig(MAP, null, null)
//
//        then:
...
//
//        when:
//        result = nextflow.k8s.client.ClientConfig.fromNextflowConfig(MAP, 'ns1', 'sa2')
//        then:
//        result.server == 'foo.com'
//        result.token == 'blah-blah'
