...
import nextflow.nomad.client.NomadResponseApi
...
//
//        given:
//        NomadResponseJson result
//        def client = Spy(NomadService)
//        def RESP = Mock(NomadResponseApi)
...
//        given:
//        nextflow.k8s.client.K8sResponseJson result
//        def client = Spy(NomadService)
//        def RESP = Mock(nextflow.k8s.client.K8sResponseApi)
...
//        then:
//        1 * client.podStatus(POD_NAME) >> new nextflow.k8s.client.K8sResponseJson(JSON)
//
...
//        then:
//        1 * client.podStatus(POD_NAME) >> { throw new nextflow.k8s.client.K8sResponseException("Request GET /api/v1/namespaces/xyz/pods/nf-xyz/status returned an error code=404", new ByteArrayInputStream(JSON.bytes)) }
//
//        and:
...
//        client.podState(POD_NAME)
//        then:
//        1 * client.podStatus(POD_NAME) >> new nextflow.k8s.client.K8sResponseJson([:])
//        e = thrown(nextflow.k8s.client.K8sResponseException)
//        e.message.startsWith('K8s undetermined status conditions for pod')
//
//        when:
//        client.podState(POD_NAME)
//        then:
//        1 * client.podStatus(POD_NAME) >> new nextflow.k8s.client.K8sResponseJson([status:[containerStatuses: []]])
//        e = thrown(nextflow.k8s.client.K8sResponseException)
//        e.message.startsWith('K8s undetermined status conditions for pod')
//
//        when:
//        client.podState(POD_NAME)
//        then:
//        1 * client.podStatus(POD_NAME) >> new nextflow.k8s.client.K8sResponseJson([status:[containerStatuses: [[name: 'foo'] ]]])
//        e = thrown(nextflow.k8s.client.K8sResponseException)
...
//        client.podState(POD_NAME)
//        then:
//        1 * client.podStatus(POD_NAME) >> new nextflow.k8s.client.K8sResponseJson([status:[containerStatuses: [[name: POD_NAME] ]]])
//        e = thrown(nextflow.k8s.client.K8sResponseException)
...
//        def result = client.podState(POD_NAME)
//        then:
//        1 * client.podStatus(POD_NAME) >> new nextflow.k8s.client.K8sResponseJson([status:[containerStatuses: [[name: POD_NAME, state: STATE] ]]])
//        result == STATE
//    }
//
...
//        then:
//        1 * client.podStatus(POD_NAME) >> new nextflow.k8s.client.K8sResponseJson(JSON)
//        def e = thrown(nextflow.k8s.client.PodUnschedulableException)
